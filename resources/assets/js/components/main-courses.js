...
$(document).ready(function () {
    ...
    player.on('ended', function () {
        ...
        $.ajax({
            ...
            url: '/update-progress',
            data: {
                no: lessonNo, currentLess: currentLesson, currentCour: currentCourse
            },
                    ...
                    if(time == 0){
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if(data[i].id > currentLesson){
                                ...
                                window.location.replace("/courses/course-content/" + currentCourse + "/" + id);
                                break;
                            }
                        }
    ...
    let quizForm
    const mainQuizForm = $("#mainQuizForm");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (resultPer >= finalScore) {
                    ...
                    $(".quiz-result-status-result").html("You need to review the course again and retake the quiz");
    ...
    // on click retake quiz


    $("#quiz-result-button-fail").on("click", function (e) {
