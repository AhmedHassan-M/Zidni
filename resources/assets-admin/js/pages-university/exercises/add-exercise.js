$(document).ready(function() {
    const AddQuizzesForm = $("#AddQuizzesForm1");
    ...
    $("#quizQuestionsCounter1 span").html(questionsCounter);

    $("#quizQuestionsCounterInput1").val(questionsCounter);
    ...
    function calculateSum() {
        ...
        $("#totalScoreCounter1 span").html(sum);

        $("#quizScoreCounterInput1").val(sum);
    }
    ...
    $(document).on("click", ".addOtherQuestions", function() {
        ...
        $("#quizQuestionsWrapper1").append(newQuiz.fadeIn());
    ...
    $("#AddQuizzesForm1").on("submit", function(e) {
        radioError();
