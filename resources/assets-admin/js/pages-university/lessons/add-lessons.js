$(document).ready(function() {
    ...
    const createNewElement = () => {
        let elementCardContainer = $("#lessonElementsContainer .lesson-card");
        ...
        if (elementCardContainer.length <= 4) {
            $("#lessonElementsContainer").append(newElementCard);
    ...
    const createNewVoice = () => {
        let voiceCardContainer = $("#lessonVoiceContainer .voice-card");
        ...
        if (voiceCardContainer.length <= 30) {
            $("#lessonVoiceContainer").append(newVoiceCard);
    ...
    $(document).on("click", "#addVoice", function(e) {
        e.preventDefault();
        createNewVoice();
    });
