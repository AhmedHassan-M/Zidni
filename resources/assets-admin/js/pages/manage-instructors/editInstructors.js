...
$(document).ready(function () {
    ...
    let editInstructorsForm = $('#editInstructorsForm')

    editInstructorsForm.validate({
        rules: {
            instructorsFullName: {
                required: true,
        ...
        submitHandler: function (form, e) {
            ...
            var dayID = pathArray[3];
            console.log(dayID);
    
            $.ajax({
                type: "POST",
                url: "/admin/edit-instructor/"+dayID,
                data: form_data,
                ...
                success: function (data) {
                    ...
                    Swal({
                        title: "Successfully updated " + instructorsFullName + " as Zidni Instructor ",
