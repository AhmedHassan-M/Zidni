...
<style>
    ...
    .filepond--file-action-button:not(disabled) {
        cursor: pointer;
    }
</style>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card applicant-profile-card">
                                ...
                                <div class="card-block">
                                    <h4 class="card-title">
                                        <input type="text" class="add_student_input title" name="student_name" placeholder="John Doe" required>
                                    </h4>
                                    ...
                                    <table class="table-fill">
                                        <tbody class="table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <input type="text" class="add_student_input" name="student_name" placeholder="johndoe@domain.com" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-left">Phone Number</td>
                                                <td class="text-left">
                                                    <input type="text" class="add_student_input" name="student_name" placeholder="+20 1062117782" required>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <input type="text" class="add_student_input" name="student_name" placeholder="5468768465498468" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-left">Full Name In Latin</td>
                                                <td class="text-left">
                                                    <input type="text" class="add_student_input" name="student_name" placeholder="John Doe" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-left">Full Name In Arabic</td>
                                                <td class="text-left">
                                                    <input type="text" class="add_student_input" name="student_name" placeholder="إسم مجهول" required>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <select name="studentSpecialization" class="form-control form-select-active" placeholder="Select Specialization">
                                                        <option></option>
                                                        @for ($i = 0; $i < 3; $i++)
                                                        <option value="id">Specialization Name</option>
                                                        @endfor
                                                    </select>
                                                </td>
                                            </tr>
                                ...
                                <div class="form-submit"><button type="submit" class="btn btn-secondary btn-lg btn-block">Add Student</button></div>
