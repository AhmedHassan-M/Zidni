...
@section('title', 'Zidni Applicants')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Manage Zidni University Applicants</h2>
                    <p>This board show you all Applicants for Zidni University</p>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin/university/home">University Dashboard</a></li>
                            <li class="breadcrumb-item active"><a href="/admin/all-user">Manage Zidni University Applicants</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-body">
                ...
                <section id="html-markup" class="card">
                    <div class="card-header">
                        <h4 class="card-title">Zidni University Applicants</h4>
...
<script type="text/javascript" src="{{asset('admin/js/pages-university/applicant/all-applicant.js')}}"></script>
