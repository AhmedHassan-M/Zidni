...
@section('title', 'Zidni Add Date & Time')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-1">
                <h2 class="content-header-title">Manage Zidni University Add Date & Time</h2>
                <p>This board show add Date & Time for Zidni University</p>
            </div>
        ...
        <div class="content-body">
            ...
            <section id="html-markup" class="card">
                <div class="card-header">
                    <h4 class="card-title">Zidni University Add Date & Time</h4>
                ...
                <div class="card-body collapse in">
                    ...
                    <div class="container">
                        ...
                        <form class="university-form-style" id="addDateAndTimeForm">
                            ...
                            <div class="two-inputs">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control time-input pickatime-start" value="" name="startTime" id="startTime" placeholder="Start From">
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control time-input pickatime-end" value="" name="endTime" id="endTime" placeholder="End At">
                                    </div>
                            ...
                            <div class="form-submit"><button type="submit"
                                    class="btn btn-secondary btn-lg btn-block">Create Date & Time</button>
...
<script type="text/javascript" src="{{asset('admin/js/pages-university/date-time/add-date-time.js')}}"></script>
