                                ...
                                <div class="content-body">
                                    ...
                                    <section class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Zidni Activity</h4>
                                                        ...
                                                        <div class="card-block">
                                                            <div class="media">
                                                                <div class="media-body text-xs-left">
                                                                    <h3 class="statistics-counter">{{count($students)}}</h3>
                                                                    <span class="statistics-title">Active Users</span>
                                                                </div>
                                                                ...
                                                                <div class="statistics-link">
                                                                    ...
                                                                    <a href="/admin/all-users">See All Users</a>
                                                ...
                                                <div class="card statistics">
                                                    <div class="card-body">
                                                        <div class="card-block">
                                                            <div class="media">
                                                                <div class="media-body text-xs-left">
                                                                    <h3 class="statistics-counter">{{count($activeCourses)}}</h3>
                                                                    <span class="statistics-title">Active Course</span>
                                                                </div>
                                                                <div class="media-right media-middle">
                                                                ...
                                                                <div class="statistics-link">
                                                                    ...
                                                                    <a href="/admin/all-courses">See All courses</a>
                                                ...
                                                <div class="card statistics">
                                                    <div class="card-body">
                                                        <div class="card-block">
                                                            <div class="media">
                                                                <div class="media-body text-xs-left">
                                                                    <h3 class="statistics-counter">{{count($quizzes)}}</h3>
                                                                    <span class="statistics-title">Active Quiz</span>
                                                                </div>
                                                                <div class="media-right media-middle">
                                                                ...
                                                                <div class="statistics-link">
                                                                    ...
                                                                    <a href="/admin/all-quizzes">See All Quizzes</a>
                                                ...
                                                <div class="card statistics">
                                                    <div class="card-body">
                                                        <div class="card-block">
                                                            <div class="media">
                                                                <div class="media-body text-xs-left">
                                                                    <h3 class="statistics-counter">{{count($subscribers)}}</h3>
                                                                    <span class="statistics-title">Subscriber</span>
                                                                </div>
                                                                <div class="media-right media-middle">
                                                                ...
                                                                <div class="statistics-link">
                                                                    ...
                                                                    <a href="/admin/subscribe-inbox">See All Subscribe</a>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-header">
                                                                <h4 class="card-title">Courses, Masters & Specializations</h4>
                                                                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                                                                <div class="heading-elements">
                                                                    <ul class="list-inline mb-0">
                                                    ...
                                                    <div class="col-xl-6 col-lg-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-header">
                                                                <h4 class="card-title">Users Tracking</h4>
                                                                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                                                                <div class="heading-elements">
                                                                    <ul class="list-inline mb-0">
                                                                        <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
...
$(window).on("load", function() {
    ...
    var coursesActivity = {{json_encode($coursesActivity)}};
    var mastersActivity = {{json_encode($mastersActivity)}};
    var specsActivity = {{json_encode($specsActivity)}};
    var coursesNo = {{json_encode($coursesNo)}};
    var mastersNo = {{json_encode($mastersNo)}};
    var specializationsNo = {{json_encode($specializationsNo)}};
    var usersTracking = {{json_encode($usersTracking)}};
