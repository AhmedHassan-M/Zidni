                                                    ...
                                                    <div class="tab-pane active" id="account" role="tabpanel">
                                                            ...
                                                            <form id="editAdminAccountForm">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="instructorAccountName">Instructor Name</label>
                                                                        <input type="text" class="form-control" id="instructorAccountName" value="{{Auth::user()->full_name}}" name="instructorAccountName">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="email-change-container">
                                                                            ...
                                                                            <input type="email" class="form-control" id="instructorAccountEmail" placeholder="Email" value="{{Auth::user()->email}}" name="instructorAccountEmail"
                                                                                disabled>
