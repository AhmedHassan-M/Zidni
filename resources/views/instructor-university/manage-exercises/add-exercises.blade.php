...
@section('title', 'Zidni Add Exercises')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-1">
                <h2 class="content-header-title">Manage Add Exercises</h2>
                <p>This board give you easy way to add new Exercises</p>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                <div class="breadcrumb-wrapper col-xs-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/university/home">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="#">Manage Add Exercises</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="{{asset('admin/js/instructor/exercises/add-exercise.js')}}"></script>
