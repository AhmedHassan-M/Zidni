    ...
    <div class="content-wrapper">
            ...
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                <div class="breadcrumb-wrapper col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="/instructor/courses">Zidni University All Course</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="content-body">
            ...
            <section id="html-markup" class="card">
                ...
                <div id="nav-material" class="card-body collapse in tab-pane fade active">
...
<script type="text/javascript" src="{{asset('admin/js/instructor/courses/edit-courses.js')}}"></script>
