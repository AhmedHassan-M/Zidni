        ...
        <div class="container">
            ...
            <div class="pages-header-container">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="/specialization/{{$master->id}}">Specialization</a>
                        </li>
                ...
                <div class="all-corses-main-title">
                    ...
                    <h1 class="display-4 page-header-title">{{$master->name}}</h1>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="progress-container">
                                    ...
                                    <div class="progress-title">
                                            ...
                                            <h5>{{$master->name}} Specialization Overall All Progress</h5>
                            ...
                            <div class="get-certificate-button">
                                @if(count($enroll) > 0)
                                    ...
                                    @elseif($enroll[0]->progress >= 100)
                                        <a href="/get-certificate/master-degree/{{$enroll[0]->id}}" id="get-certificate" class="btn btn-secondary get-certificate">Get The Certificate</a>
                                    @endif
                                @endif
                            </div>
                        ...
                        @foreach ($courses as $course)
                         ...
                         <div class="my-courses-item">
                            ...
                            <div class="my-courses-item-progressbar">
                                ...
                                <p class="courses-list-overview">{!!$course->overview!!}</p>
                                    ...
                                    <div class="my-courses-item-button">
                                        ...
                                        <button onclick="window.location.href = '/master-degree/course-content/'+{{$master->id}}+'/'+{{$course->id}};" type="button" class="btn btn-primary go-to-course-button">Go to Course</button>
