                ...
                <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="progress-container">
                                    ...
                                    <div class="progress-title">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar three-sec-ease-in-out" role="progressbar" data-transitiongoal="{{$currentEnroll[0]->progress}}"></div>
                                        </div>
                                        @endif
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="get-certificate-button">
                                ...
                                <button id="get-certificate" class="btn btn-secondary get-certificate"><a href="/master-degree/courses-list/{{$master->id}}">Courses List</a></button>
                                                        ...
                                                        <ul class="main-lessons-container" data-simplebar>
                                                                ...
                                                                @foreach ($weeks->lesson as $lessons)
                                                                                ...
                                                                                @if($lessons->id == $lesson->id)
                                                                                        @if($status[$index] == 1)
                                                                                        <a class="active courses-lesson-links courses-lesson-done" href="/master-degree/course-content/{{$master->id}}/{{$course->id}}/{{$lessons->id}}"><li class="main-lessons-item">
                                                                                        @elseif($status[$index] == 0)
                                                                                        <a class="active courses-lesson-links" href="/master-degree/course-content/{{$master->id}}/{{$course->id}}/{{$lessons->id}}"><li class="main-lessons-item">
                                                                                        @endif
                                                                                @else
                                                                                        @if($status[$index] == 1)
                                                                                        <a class="courses-lesson-links courses-lesson-done" href="/master-degree/course-content/{{$master->id}}/{{$course->id}}/{{$lessons->id}}"><li class="main-lessons-item">
                                                                                        @elseif($status[$index] == 0)
                                                                                        <a class="courses-lesson-links" href="/master-degree/course-content/{{$master->id}}/{{$course->id}}/{{$lessons->id}}"><li class="main-lessons-item">
                                                                                        @endif
                                                                                @endif
...
{{-- ui-state-disabled for disabled quiz --}}
                                                @if(count($currentEnroll) > 0)
                                                @if($currentEnroll[0]->progress == 100)
                                ...
                                <div class="col-md-8">
                                                ...
                                                <div class="load-box">
                                                        ...
                                                        <div class="load-wizard-box">
                                                                ...
                                                                <form id="masterQuizForm">
                                                                        ...
                                                                        <input type="hidden" name="enrollID" value="{{$currentEnroll[0]->id}}">
                                        ...
                                        <div class="quiz-result-container">
                                                ...
                                                <div class="quiz-result-button">
                                                        ...
                                                        <button id="quiz-result-button-pass" type="button" class="btn btn-primary btn-lg"><a href="/master-degree/courses-list/{{$master->id}}">Courses List</a></button>
                                                        
                                                        @foreach ($weeks->lesson as $lessons)
                                                                @if($lessons->id == $lesson->id)
                                                                <button id="quiz-result-button-fail" type="button" class="btn btn-primary btn-lg"><a href="/master-degree/course-content/{{$master->id}}/{{$course->id}}/{{$lessons->id}}">Retake the quiz</a></button>
                                                                @endif
                                                        @endforeach
...
<script type="text/javascript" src="{{asset('js/main-master.js')}}"></script>
<script>
