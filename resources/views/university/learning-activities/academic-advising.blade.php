...
@section('title', trans("user-university.academic-advising"))
...
@for ($i = 1; $i < 5; $i++)
    ...
    <div class="card student-lesson-card mb-3">
            <div class="row no-gutters">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('user-university.advising-info') }}</h5>
                ...
                <div class="col-md-5">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('user-university.advising-content') }}</h5>
            ...
            <div class="card-footer">   
                ...
                <small class="text-muted">{{ __('user-university.advising-will-start-after') }} : 00:00:00</small>
